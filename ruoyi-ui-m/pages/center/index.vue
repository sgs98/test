<template>
      ...
      <view style="padding: 40rpx 40rpx 0 40rpx;">
        <view class="profile-rule">
          <u-row>
            ...
            <u-col span="4">
              <u-button icon="question-circle" text="问题反馈" style="height: 36px;" @click="callPhoneNumber"></u-button>
            </u-col>
          </u-row>
        </view>
      </view>
    ...
    <view style="padding: 40rpx; margin-top: 300rpx;">
      <u-row gutter="32">
        <u-col span="6">
          <u-button icon="phone" text="联系我们" plain @click="callPhoneNumber"></u-button>
        </u-col>
        <u-col span="6">
